...
public final class OrderStatusQueryCommandDecoder
{
    ...
    private final OrderStatusQueryCommandDecoder parentMessage = this;
    ...
    public OrderStatusQueryCommandDecoder wrap(
    ...
    public OrderStatusQueryCommandDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrderStatusQueryCommandDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[OrderStatusQueryCommand](sbeTemplateId=");
    ...
    public OrderStatusQueryCommandDecoder sbeSkip()
    {
        sbeRewind();
        skipVenueOrderId();
